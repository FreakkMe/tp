    ...
    private static final ObservableList<CommandEntry> COMMAND_LIST =
            FXCollections.observableArrayList(
                ...
                new CommandEntry("find",
                        ...
                        "Search persons by name, phone, email, address, or tag"),
                new CommandEntry("edit-i",
                        "edit-i INDEX",
                        "Open interview note editor for a person (creates or updates)"),
                new CommandEntry("delete-i",
                        "delete-i INDEX",
                        "Delete the interview record linked to a person"),
                new CommandEntry("list-i",
                        "list-i",
                        "List all interview records in the database"),
                new CommandEntry("find-i",
                        "find-i KEYWORD [MORE_KEYWORDS]…",
                        "Search persons by interview record"),
                new CommandEntry("clear",
                        "clear",
                        "Delete all persons and interview records"),
